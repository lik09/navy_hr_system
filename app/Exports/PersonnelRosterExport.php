...
class PersonnelRosterExport implements FromArray, WithHeadings, WithColumnWidths, WithEvents, WithTitle
{
    ...
    protected function columns(): array
    {
        $cols = [
            ...
            ['heading' => 'លេខអត្ត.យោធា',          'width' => 20, 'red' => false, 'value' => fn (PersonalInfo $p) => $p->military_id ?: '—'],
            ['heading' => 'លេខអត្ត.សុីវិល',         'width' => 30, 'red' => false, 'value' => fn (PersonalInfo $p) => $p->civilian_id ?: '—'],
